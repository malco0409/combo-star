...
const links = [
  ...
  { to: "/admin/mahsulotlar",   icon: "🛍️", label: "Mahsulotlar",      roles: ["admin"] },
  { to: "/admin/kolleksiyalar", icon: "🎨", label: "Kolleksiya/Ranglar", roles: ["admin"] },
  { to: "/admin/sozlamalar",    icon: "🎬", label: "Sozlamalar (video)", roles: ["admin"] },
    ...
    <div className="flex min-h-screen" style={{ background: "#0f1117" }}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4"
          ...
          <Link to="/" title="Saytga o'tish" className="block">
            <div className="text-base font-semibold" style={{ color: "#a80000" }}>Combo St★r</div>
            <div className="text-xs mt-0.5" style={{ color: "#64748b" }}>Saytga o'tish →</div>
          </Link>
          <button
            onClick={() => setOpen(false)}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <Link to="/" className="font-semibold text-sm" style={{ color: "#a80000" }}>Combo St★r</Link>
        </header>
