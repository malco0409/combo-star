...
export default function CollectionDetail() {
  ...
  // Tanlangan rang — name o'rniga index ishlatamiz (tildan mustaqil)
  ...
  const colorDisplayName = selectedColorObj?.nameKey ? t(selectedColorObj.nameKey) : colorName;
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                {collection.colors.map((c, idx) => (
                  <div key={c.name}
                    ...
                    {c.image ? (
                      <img src={c.image} alt={c.nameKey ? t(c.nameKey) : c.name} className="w-full h-20 object-cover" />
                    ) : (
